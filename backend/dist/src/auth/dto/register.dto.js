...
__decorate([
    ...
    (0, class_validator_1.Matches)(/^(?=.*[A-Za-z])(?=.*\d)[A-Za-z\d\W_]{8,}$/, { message: 'Password must contain at least one letter and one number' }),
    __metadata("design:type", String)
...
__decorate([
    (0, swagger_1.ApiProperty)({ example: '+919999999999', required: false }),
